...
export default class Snack extends Component {
  ...
  updateTotal = () => {
    this.setState({ total: this.state.num_snack * this.props.snack.i_precio });
  };

  downsnack = () => {
    if (this.state.num_snack > 0) {
      this.setState({ num_snack: this.state.num_snack - 1 });
      this.updateTotal();
  ...
  selectImage = () => {
    if (this.props.snack.v_tipo === "Bebida") {
      return require("../../resources/img/soda.png");
    } else if (this.props.snack.v_tipo === "Palomitas") {
      return require("../../resources/img/palomitas.png");
    } else if (this.props.snack.v_tipo === "Dulces") {
      return require("../../resources/img/dulces.png");
    } else if (
      this.props.snack.v_tipo === "Comida Rapida" &&
      this.props.snack.v_nombre.indexOf("Perro") !== -1
    ) {
      return require("../../resources/img/hotdog.png");
    } else {
      return require("../../resources/img/hamburguer.png");
    }
  };
        ...
        <div className="card">
          ...
          <div className="snack_cover">
            <div className="snack_att">
              <img
                className="img_cover"
                src={require("../../resources/img/peso.png")}
                alt="snack_image"
              />
              <p>Q{this.props.snack.i_precio}</p>
            </div>
            <div className="snack_att">
              <img
                className="img_cover"
                src={require("../../resources/img/puntos.png")}
                alt="snack_image"
              />
