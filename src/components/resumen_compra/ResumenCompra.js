        ...
        <div className="summary_content">
          ...
          <div className="summary_tickets">
            ...
            <div className="ticket_general_sumary">
              ...
              <div className="ticket_cost">
                ...
                <p>Q{this.props.objBoletas.boletasGeneral * 10000}</p>
              </div>
            </div>
            <div className="ticket_vip_sumary">
              ...
              <div className="ticket_cost">
                <p>Q{this.props.objBoletas.boletasVip * 16000}</p>
              </div>
            </div>
            <div className="ticket_total">
              ...
              <div className="ticket_cost_total">
                <h4>Total</h4>
                <p>Q{this.props.objBoletas.total}</p>
              </div>
            </div>
          </div>
          <div className="summary_chairs">
            ...
            <div className="chair_general_sumary">
              ...
              <div className="chair_code">
                ...
                <p>
                  {this.props.objSillas.sSeleccionadas.map((silla) => {
          ...
          <div className="summary_food">
            ...
            <div className="food_points">
              ...
              {this.props.objSnacks.snaksSeleccionados.map((snack) => {
                if (snack.numero > 0) {
                  return (
                    <p key={snack.id}>
                      {snack.i_puntosofrecidos * snack.numero}
                    </p>
                  );
                } else {
                  return null;
            ...
            <div className="food_cost">
              ...
              {this.props.objSnacks.snaksSeleccionados.map((snack) => {
                if (snack.numero > 0) {
                  return <p key={snack.id}>Q{snack.i_precio}</p>;
                } else {
                  return null;
                }
              })}
            ...
            <div className="ticket_total">
              ...
              <div className="ticket_cost_total">
                <h4>Total</h4>
                <p>Q{this.props.objSnacks.sumaTotal}</p>
              </div>
            </div>
          </div>
          <div className="summary_total">
            ...
            <div className="total_numer">
              <h4>
                Q{this.props.objBoletas.total + this.props.objSnacks.sumaTotal}
              </h4>
            </div>
          </div>
          <div className="summary_total">
            ...
            <div className="total_numer">
              <h4>
                {this.props.objBoletas.puntos +
                  this.props.objSnacks.puntosTotal}
              </h4>
            </div>
          </div>
          <div className="button_sumary_confirm">
            <Link
              className="button_sumary_confirm_link"
              to="/TarjetaCredito"
              onClick={this.confirmarReserva}
            >
              <button className="btn_sumary_confirm">Confirmar</button>
            </Link>
          </div>
        </div>
