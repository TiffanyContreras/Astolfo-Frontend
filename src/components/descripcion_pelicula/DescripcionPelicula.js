...
export default class DescripcionPelicula extends Component {
  ...
  consultarFunciones = (id, fecha) => {
    ...
    axios
      .get("https://astolfo.fly.dev/funciones/" + fecha + "/" + id)
      .then((response) => {
        this.setState({
          list_funciones: response.data.data[0],
          horarios: true,
        });
      })
      .catch((error) => {
      ...
      <div className="container">
        <div className="movie_info_stadistics">
          <div className="movie_img_dif">
            <img
              className="img_movie_desc"
              src={this.props.pelicula.v_foto}
              alt="movie_image_desc"
            />
          </div>
          ...
          <div className="movie_ranking">
            <div className="stars_ranking">
              <img
                ...
                src="https://img.icons8.com/office/30/000000/star--v1.png"
                alt="star_rank"
              />
              4.0/5.0
            </div>
          ...
          <div className="movie_more_info">
            <div className="more_info_div">
              <img
                className="more_info_img"
                src={require("../../resources/img/direccion.png")}
                alt="direct_img"
              />
            ...
            <div className="more_info_div">
              <img
                className="more_info_img"
                src={require("../../resources/img/calendario.png")}
                alt="calendary_img"
              />
            ...
            <div className="more_info_div">
              <img
                className="more_info_img"
                src={require("../../resources/img/ubicacion.png")}
                alt="country_img"
              />
            ...
            <div className="more_info_div">
              <img
                className="more_info_img"
                src={require("../../resources/img/reloj.png")}
                alt="clock_img"
              />
              <p className="info_title">Duracion:</p>
              <p className="info_text">
                {this.props.pelicula.i_duracion} minutos
              </p>
            </div>
            <div className="more_info_div">
              <img
                className="more_info_img"
                src={require("../../resources/img/idiomas.png")}
                alt="lenguaje_img"
              />
            ...
            <div className="more_info_div">
              <img
                className="more_info_img"
                src={require("../../resources/img/carrete.png")}
                alt="carret_img"
              />
        ...
        <div className="movie_info_detals">
          ...
          <div className="scroll_dates">
            <FechasScroll
              consultarFunciones={this.consultarFunciones}
              id={this.props.pelicula.id}
            />
          </div>
