...
export default class PanelConfirmacion extends Component {
  ...
  showAlert = (event) => {
    ...
    toast("Debes iniciar sesión para poder reservar", {
      type: "error",
    });
  };
  ...
  render() {
    return (
      <div className="panel_complete">
        <div
          ref={this.props.panelBackground}
          id="panel_background"
          className="panel_background"
        ></div>
        <div
          ref={this.props.panel}
          id="panel_confirmation"
          className="panel_confirmation"
        >
          ...
          <div className="info_confirmations">
            ...
            <button
              ...
              onClick={this.movePanelConfirmation}
            >
              Cancelar
            </button>
          </div>
